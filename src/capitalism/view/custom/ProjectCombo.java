...
public class ProjectCombo extends ComboBox<Project> {
	private static final Logger logger = LogManager.getLogger(ProjectCombo.class);

	public ProjectCombo(ObservableList<Project> projects, String prompt) {
		super(projects);
	...
	public ProjectCombo(ObservableList<Project> items) {
		super(items);
	}
}

 ...
 CREATE TABLE `circuits` ( `project` int default 1 not null, `timeStamp` VARCHAR (10) DEFAULT '1' not null, `productUseValueType` Varchar(45)not null, `Output` double DEFAULT NULL, `MaximumOutput` double DEFAULT NULL, GrowthRate double DEFAULT 0, InitialCapital double DEFAULT NULL, CurrentCapital double DEFAULT NULL, Profit double DEFAULT NULL, RateOfProfit double DEFAULT NULL, primary key (project, timeStamp, ProductUseValueType) ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
 ...
 CREATE TABLE `useValues` ( `project` int default 1 not null, `timeStamp` VARCHAR (10) DEFAULT '1' not null, `useValueType` varchar(45) not NULL,`useValueCircuitType` varchar(45) DEFAULT NULL, `description` varchar(45) DEFAULT NULL, `unitValue` double DEFAULT NULL, `unitPrice` double DEFAULT NULL, `turnoverTime` double DEFAULT NULL, totalSupply double default NULL, totalQuantity double default NULL, totalDemand double default NULL,  surplus double DEFAULT 0, totalValue double default NULL, totalPrice double default NULL, allocationShare double default null, primary key (project, timeStamp, useValueType) ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
 ...
 insert into globals (project,timeStamp,RateOfExploitation,Melt,Profit,ProfitRate,PopulationGrowthRate,totalValue,totalPrice, investmentRatio,labourSupplyResponse) select project,timeStamp,RateOfExploitation,Melt,Profit, ProfitRate,PopulationGrowthRate,totalValue,totalPrice,investmentRatio,labourSupplyResponse from CSVREAD('~/Documents/Capsim/data/globals.csv');
 insert into socialClasses select * from CSVREAD('~/Documents/Capsim/data/socialClasses.csv');	
 insert into circuits (PROJECT, TIMESTAMP, PRODUCTUSEVALUETYPE, OUTPUT, MAXIMUMOUTPUT, GROWTHRATE) select PROJECT, TIMESTAMP, PRODUCTUSEVALUETYPE, OUTPUT, MAXIMUMOUTPUT, GROWTHRATE  from CSVREAD('~/Documents/Capsim/data/circuits.csv');
